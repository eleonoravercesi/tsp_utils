...
- Support for **distance matrix computation**
...
- `stsp.create_tsp_problem_object` which creates a `tsplib95.tsp.TSPProblem` object
...
- `stsp.write_tsplib` that writes a TSP instance in TSPLIB format
